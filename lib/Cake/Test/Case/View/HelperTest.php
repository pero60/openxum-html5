 ...
 */
	public function testAssetTimestamp() {
		...
		$result = $this->Helper->assetTimestamp(Configure::read('App.cssBaseUrl') . 'portfolio.css');
		$this->assertEquals(Configure::read('App.cssBaseUrl') . 'portfolio.css', $result);

		Configure::write('Asset.timestamp', true);
		Configure::write('debug', 0);

		$result = $this->Helper->assetTimestamp('/%3Cb%3E/portfolio.css');
		$this->assertEquals('/%3Cb%3E/portfolio.css', $result);
		...
		$result = $this->Helper->assetTimestamp(Configure::read('App.cssBaseUrl') . 'portfolio.css');
		$this->assertRegExp('/' . preg_quote(Configure::read('App.cssBaseUrl') . 'portfolio.css?', '/') . '[0-9]+/', $result);
		...
		$result = $this->Helper->assetTimestamp(Configure::read('App.cssBaseUrl') . 'portfolio.css?someparam');
		$this->assertEquals(Configure::read('App.cssBaseUrl') . 'portfolio.css?someparam', $result);

		$this->Helper->request->webroot = '/some/dir/';
		$result = $this->Helper->assetTimestamp('/some/dir/' . Configure::read('App.cssBaseUrl') . 'portfolio.css');
		$this->assertRegExp('/' . preg_quote(Configure::read('App.cssBaseUrl') . 'portfolio.css?', '/') . '[0-9]+/', $result);
	}
 ...
 */
	public function testAssetUrlTimestampForce() {
		...
		$result = $this->Helper->assetUrl('portfolio.css', array('pathPrefix' => Configure::read('App.cssBaseUrl')));
		$this->assertRegExp('/' . preg_quote(Configure::read('App.cssBaseUrl') . 'portfolio.css?', '/') . '[0-9]+/', $result);
	}
