 ...
 */
	public function testGetTemplate() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Pages' . DS . 'display.ctp';
 ...
 */
	public function testGetViewFileNames() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Pages' . DS . 'page.display.ctp';
 ...
 */
	public function testViewFileName() {
		...
		$this->assertRegExp('/Pages(\/|\\\)display.ctp/', $result);
